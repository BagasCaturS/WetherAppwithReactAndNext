...
const WeatherApp = () => {
  ...
  return (
    <div className="mx-auto container p-4 flex justify-center items-center flex-col min-h-screen">
      <div id="main" className="bg-slate-700 p-4 rounded-md">
        ...
        <div className="flex items-center justify-center mb-4 gap-2">
          ...
          <svg
            id="search"
            className="cursor-pointer btn btn-circle p-2 btn-ghost"
        ...
        {error ? (
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="flex w-full items-center justify-around mb-4">
              <div className="badge badge-outline badge-accent">Latitude: {coord.latitude ?? '--'}</div>
              <div className="badge badge-outline badge-accent">Longitude: {coord.longitude ?? '--'}</div>
            </div>
